...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  // Focus Zone badges
  { id: 'focus_3', name: 'Focused Starter', description: '3-day focus streak', icon: 'Headphones', tier: 'Common', category: 'Streak', criteria: 3 },
  { id: 'focus_7', name: 'Deep Diver', description: '7-day focus streak', icon: 'Headphones', tier: 'Rare', category: 'Streak', criteria: 7 },
  { id: 'focus_30', name: 'Flow Master', description: '30-day focus streak', icon: 'Headphones', tier: 'Epic', category: 'Streak', criteria: 30 },
  { id: 'focus_100', name: 'Zen Focus Legend', description: '100-day focus streak', icon: 'Headphones', tier: 'Legendary', category: 'Streak', criteria: 100 },
  { id: 'focus_10_sessions', name: 'Focus Beginner', description: '10 focus sessions', icon: 'Headphones', tier: 'Common', category: 'Productivity', criteria: 10 },
  { id: 'focus_50_sessions', name: 'Focus Regular', description: '50 focus sessions', icon: 'Headphones', tier: 'Rare', category: 'Productivity', criteria: 50 },
  { id: 'focus_100_sessions', name: 'Focus Obsessed', description: '100 focus sessions', icon: 'Headphones', tier: 'Epic', category: 'Productivity', criteria: 100 },
  { id: 'focus_10_hours', name: 'Time Invested', description: '10 hours of focus', icon: 'Clock', tier: 'Common', category: 'Quality', criteria: 10 },
  { id: 'focus_100_hours', name: 'Focus Marathoner', description: '100 hours of focus', icon: 'Clock', tier: 'Legendary', category: 'Quality', criteria: 100 },
];
