...
export function Completions() {
    ...
    return (
        <div
            className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-6 select-none bg-[#030712] w-full">
            <PageHeader
                icon={Award}
                badge="Completions"
                color="emerald"
            ...
            {loading ? (
                ...
                <div className="space-y-6">
                    ...
                    {!hasCompletions ? (
                        <div
                            className="text-center py-24 bg-[#0d1117] rounded-3xl border border-dashed border-[#21262d]">
                            ...
                            <p className="text-[#8b949e] max-w-sm mx-auto mt-1 text-xs">Completed quests and scheduled
                                                ...
                                                >
                                                    ...
                                                    <div className="flex justify-between items-center">
                                                        <div className="flex items-center gap-2">
                                                            <span
                                                                className="inline-block w-2 h-2 rounded-full bg-emerald-400 shadow-md shadow-emerald-400/50 animate-pulse"></span>
                                                            <span
                                                            ...
                                                            <div className="pt-1">
                                                                ...
                                                                <div className="space-y-2">
                                                                    {questTasks.map(t => {
                                                                        ...
                                                                        return (
                                                                            <div key={t.id}
                                                                                 className="flex items-center justify-between gap-2 p-2 bg-[#161b22] border border-[#21262d]/50 rounded-xl text-xs">
                                                                                <span
...
<p className="text-[9px] text-[#8b949e] font-mono mt-0.5">
                        ...
                        minute: '2-digit'
                                                        ...
                                                        <div
                                                            className="text-[10px] text-slate-500 italic text-center mt-1 border-t border-[#21262d]/40 pt-2 font-light">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {activeQuestsWithCompletions.map(quest => {
                                            ...
                                            return (
                                                <div key={quest.id}
                                                     className="bg-[#0d1117] border border-[#21262d] rounded-3xl p-5 flex flex-col gap-3">
                                                    <div>
                            <span
                                    ...
                                    <div className="bg-[#0d1117] border border-[#21262d] rounded-3xl p-5">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            {standaloneCompletedTasks.map(t => {
                                                ...
                                                return (
                                                    <div key={t.id}
                                                         className="flex items-center justify-between gap-3 p-3 bg-[#161b22] border border-[#21262d] rounded-2xl text-xs">
                                                        <span
