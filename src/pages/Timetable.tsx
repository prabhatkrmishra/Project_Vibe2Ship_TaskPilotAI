    ...
    const handleRescheduleRoutine = async (selectedTasks?: Task[]) => {
        ...
        if (currentSignature === lastRescheduleSignatureRef.current) {
            showInfoToast('amber', <Info
                className="w-5 h-5"/>, "Nothing to reschedule", "Nothing new to reschedule sessions — no task changes since the last update.");
            return;
        }
                ...
                {loading ? (
                    ...
                    <div className="space-y-6">
                        {(!plan || showConfig) && !isGenerating && (
                            <div
                                className="space-y-6 bg-indigo-500/5 p-5 md:p-6 border border-indigo-500/10 rounded-2xl">
                                ...
                                <div className="space-y-2">
                                    <label
                                        className="text-xs font-bold font-mono text-slate-300 uppercase tracking-wider block">
                                                    ...
                                                    <div key={i} id={`session-card-${i}`} className="space-y-4">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <div
                                                                    className={`absolute top-0 left-0 w-full h-1 ${riskColor} ${isCompleted ? 'opacity-80' : 'opacity-40'}`}></div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        className="text-slate-600 group-hover/card:text-slate-400 cursor-grab active:cursor-grabbing hidden sm:block">
                                                                    ...
                                                                    <div className="flex flex-col sm:hidden gap-0.5">
                                                                        <button
                                                                            ...
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();
                                                                                if (i > 0) handleMobileReorder(i, i - 1);
                                                                            }}
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();
                                                                                if (i < visibleSessions.length - 1) handleMobileReorder(i, i + 1);
                                                                            }}
                                                                            className="text-slate-500 disabled:text-slate-800 disabled:cursor-not-allowed hover:text-indigo-400 p-0.5 rounded transition-colors"
                                                                        >
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        className="mx-2 sm:hidden text-slate-600">—</span>
                                                                    <span
                                                                        className="hidden sm:block text-slate-500 text-[10px]">{formatTime(session.endTime)}</span>
                                                                    <span
                                                                        className="sm:hidden text-slate-500">{formatTime(session.endTime)}</span>
                                                                </div>
                                                                ...
                                                                <div className="flex-grow min-w-0">
                                                                    ...
                                                                    <div className="flex items-center gap-2 mt-1">
                                                                        {isCompleted ? (
                                                                            <span
                                                                                className="text-[10px] text-emerald-400 flex items-center gap-1 font-bold uppercase tracking-widest">
                                        <span
                                            className="inline-block w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span>
                                        Completed
                                      </span>
                                                                        ) : isNotAttended ? (
                                                                            <span
                                                                                className="text-[10px] text-red-400/80 font-bold uppercase tracking-widest">
                                        ○ NOT ATTENDED
                                      </span>
                                                                        ) : isActive ? (
                                                                            <span
                                                                                className="text-[10px] text-indigo-400 flex items-center gap-1.5 font-bold uppercase tracking-widest">
                                        <span className="relative flex h-2 w-2">
                                          <span
                                              className="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                                          <span
                                              className="relative inline-flex rounded-full h-2 w-2 bg-indigo-500"></span>
                                        </span>
                                        Active Session
                                      </span>
                                                                        ) : isStartedPastEnd ? (
                                                                            <span
                                                                                className="text-[10px] text-amber-400 flex items-center gap-1 font-bold uppercase tracking-widest">
                                        <span className="inline-block w-1.5 h-1.5 rounded-full bg-amber-400"></span>
                                        Started
                                      </span>
                                                                        ) : !matchingTask ? (
                                                                            <span
                                                                                className="text-[10px] text-indigo-400 font-semibold uppercase tracking-widest">
                                        Discipline Routine
                                      </span>
                                                                        ) : (
                                                                            <span
                                                                                className="text-[10px] text-slate-500 font-semibold uppercase tracking-widest">
                                        Scheduled
                                      </span>
                                                                        )}
                                                                        ...
                                                                        {matchingTask && !isCompleted && (
                                                                            <>
                                                                                <span
                                                                                    className="text-slate-700 text-xs">•</span>
                                                                                <span
                                          ...
                                          {matchingTask.priority}
                                                                ...
                                                                {!isCompleted ? (
                                                                    ...
                                                                    <div
                                                                        className="text-emerald-400 shrink-0 self-center ml-2 p-2"
                                                                        title="Completed">
                                                        ...
                                                        {i < visibleSessions.length - 1 && (
                                                            <div
                                                                ...
                                                                <div
                                                                    className="absolute inset-x-0 h-[1px] bg-slate-800 group-hover/divider:bg-indigo-500/40 transition-all"/>
                                                                <button
                                                                    type="button"
                                                                    onClick={() => {
                    ...
                    <div
                        ...
                        <div className="space-y-4 py-2">
                            <div className="space-y-1">
                                <label
                                    className="text-[10px] font-bold font-mono text-slate-400 uppercase tracking-wider block">
                                    Session Title
                                </label>
                                <input
                                    type="text"
