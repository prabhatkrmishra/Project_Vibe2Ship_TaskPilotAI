...
export function Goals() {
    ...
    const showBeautifulCompletion = (goalTitle: string, goalType: 'habit' | 'quest') => {
        toast.custom((t) => (
            <div
                className="relative flex flex-col gap-3 p-6 bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#0f172a] border-2 border-emerald-400/50 rounded-3xl shadow-[0_20px_50px_rgba(16,185,129,0.3)] max-w-sm w-full text-white pointer-events-auto overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300">
                <div
                    className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/10 rounded-full blur-2xl -mr-16 -mt-16 pointer-events-none"></div>

                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                        <div
                            className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-lg shadow-emerald-500/20">
              ...
              <span
                ...
                Goal Accomplished
                    ...
                    <button onClick={() => toast.dismiss(t)}
                            className="text-slate-400 hover:text-white text-xs font-bold transition-colors bg-white/5 hover:bg-white/10 px-2.5 py-1 rounded-xl">
                        Dismiss
                    </button>
                </div>
                ...
                <div className="mt-2 border-t border-slate-800 pt-3">
                    <p className="text-slate-200 text-sm leading-relaxed">
                        Outstanding progress! You have successfully completed: <span
                        className="text-emerald-400 font-extrabold text-base tracking-tight block mt-1 drop-shadow-[0_2px_8px_rgba(52,211,153,0.2)]">{goalTitle}</span>
                    </p>
                    <span
                        className="inline-block mt-3 px-2.5 py-1 bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 text-[10px] font-bold uppercase tracking-widest rounded-full">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative w-32 h-32 mb-6">
                                ...
                                >
                                    ...
                                    <div className="absolute top-0 -mt-2.5">
                                        ...
                                        >
                                            <Plane
                                                className="w-5 h-5 text-cyan-400 transform rotate-45 drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]"/>
                                        </motion.div>
                                    </div>
                                </motion.div>
                                ...
                                {/* Center glowing core */}
                                <div
                                    className="absolute inset-8 rounded-full bg-gradient-to-tr from-cyan-950/80 to-indigo-950/80 flex items-center justify-center border border-cyan-500/30 shadow-[inset_0_0_15px_rgba(34,211,238,0.2)]">
                                    <motion.div
                                        animate={{
                                            scale: [1, 1.15, 1],
                            ...
                            <p className="text-sm text-slate-300 mb-5 px-2 leading-relaxed">
                                TaskPilot AI is designing your quest trajectory, distributing deadlines, and evaluating
                                risk structures...
                            </p>

                            {/* Pulsing state badge */}
                            <div
                                className="flex items-center gap-1 bg-cyan-500/10 border border-cyan-500/20 px-3.5 py-1.5 rounded-full">
                ...
                actions={
                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogTrigger render={
                            <Button
                                className="bg-white text-emerald-900 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-emerald-50 transition-colors shadow-lg px-4 card-lift">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-2">
                                            <div
                                                className={`p-2 rounded-xl ${type === 'habit' ? 'bg-indigo-500/20 text-indigo-400' : 'bg-slate-800 text-slate-400'}`}>
                                                <Flame className="w-5 h-5"/>
                                            </div>
                                            <h4 className={`font-semibold ${type === 'habit' ? 'text-indigo-400' : 'text-slate-300'}`}>Daily
                                                Habit</h4>
                                        </div>
                                        <p className="text-xs text-slate-500 leading-relaxed">Track daily streaks and
                                            build consistent long-term routines.</p>
                                    </button>
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-2">
                                            <div
                                                className={`p-2 rounded-xl ${type === 'quest' ? 'bg-cyan-500/20 text-cyan-400' : 'bg-slate-800 text-slate-400'}`}>
                                                <Target className="w-5 h-5"/>
                                            </div>
                                            <h4 className={`font-semibold ${type === 'quest' ? 'text-cyan-400' : 'text-slate-300'}`}>Quest</h4>
                                        </div>
                                        <p className="text-xs text-slate-500 leading-relaxed">A major goal. AI
                                            automatically breaks it down into actionable tasks.</p>
                                    </button>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2">
                                            <Input
                                                className="flex-1 bg-slate-900 border-slate-800 text-white rounded-xl h-11"
                                                value={title} onChange={e => setTitle(e.target.value)}
                                                placeholder={type === 'habit' ? "e.g. Meditate for 10 minutes" : "e.g. Launch new mobile app"}
                                                required/>
                                            <Button
                                                type="button"
                                                variant="outline"
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-slate-400">Description <span
                                            className="text-slate-600 text-xs">(Optional)</span></Label>
                                        <Input className="bg-slate-900 border-slate-800 text-white rounded-xl h-11"
                                               value={description} onChange={e => setDescription(e.target.value)}
                                               placeholder="Why is this important?"/>
                                    </div>
                                    {type === 'habit' && (
                                        <div className="space-y-2">
                                            <Label className="text-slate-400">Scheduled Time <span
                                                className="text-slate-600 text-xs">(Optional)</span></Label>
                                            <div className="relative group">
                                                <div
                                                    className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                    <Clock
                                                        className="h-4 w-4 text-slate-500 group-hover:text-indigo-500 transition-colors"/>
                                                </div>
                                                <Input
                                                    type="time"
                                            ...
                                            <p className="text-[10px] text-slate-600">Set a time for daily reminders.
                                                Leave empty for anytime habits.</p>
                                        </div>
                                    )}
                                    {type === 'quest' && (
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative group">
                                                <div
                                                    className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                    <Clock
                                                        className="h-4 w-4 text-slate-500 group-hover:text-cyan-500 transition-colors"/>
                                                </div>
                                                <Input
                                                    type="datetime-local"
                                            ...
                                            {isCheckingTimetable && (
                                                <div
                                                    className="text-[10px] text-cyan-400 animate-pulse font-mono mt-1">Comparing
                                                    against daily timetable...</div>
                                            )}
                                            {timetableConflict && (
                                                <div
                                                    className="p-3 bg-amber-500/10 border border-amber-500/20 text-amber-300 rounded-xl text-[11px] leading-relaxed font-medium animate-in fade-in duration-200 mt-1.5">
                                                    {timetableConflict}
                                                </div>
                                            )}
                                            {!timetableConflict && targetDate && !isCheckingTimetable && (
                                                <div
                                                    className="text-[10px] text-emerald-400 font-mono flex items-center gap-1 mt-1.5">
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="flex-1 min-w-0">
                                            {goal.type === 'quest' && goal.targetDate && !goal.completed && new Date(goal.targetDate).getTime() < Date.now() && (
                                                <span
                                                    className="inline-block px-2 py-0.5 mb-2 bg-red-500/10 text-red-400 border border-red-500/20 text-[10px] font-bold rounded uppercase tracking-wider">
                      Deadline Passed
                    </span>
                                            )}
...
<span
                    ...
                    Quest
                                        ...
                                        {goal.type === 'quest' && tasks.length > 0 && (
                                            <span
                                                className="px-2 py-0.5 text-[10px] font-bold rounded uppercase tracking-wider bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 flex items-center">
                    <ListTree className="w-3.5 h-3.5 mr-1"/>
                                            ...
                                            {goal.type === 'habit' ? (
                                                ...
                                                <div className="w-full space-y-3">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <span
                                                            className="text-xs font-mono text-cyan-400 shrink-0">{goal.progress}%</span>
                                                    </div>
                          ...
                          <span className="flex items-center gap-1.5">
                            <ListTree className="w-3.5 h-3.5"/> Scheduled Tasks <span
                              className="text-cyan-400 font-mono">({completedTasks}/{tasks.length})</span>
                          </span>
                                                                <span
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div className="flex-1 min-w-0">
                                                                                            {editingTaskId === t.id ? (
                                                                                                ...
                                                                                                <span
                                                                                                    className={`text-sm block truncate ${t.status === 'completed' ? 'text-slate-500 line-through' : 'text-slate-200'}`}>
                                            {t.title}
                                          </span>
                                                                                            )}
<span
                          ...
                          <span className="flex items-center gap-1.5">
                            <Route className="w-3.5 h-3.5"/> Quest Trail <span
                              className="text-cyan-400 font-mono">({questTrails[goal.id].length} sessions)</span>
                          </span>
                                                            </button>
                                                            <div className="mt-2 space-y-0 relative">
                                                                <div
                                                                    className="absolute left-[7px] top-2 bottom-2 w-px bg-gradient-to-b from-cyan-500/40 via-indigo-500/30 to-transparent"></div>
                                                    ...
                                                    <div className="mt-3 pt-3 border-t border-[#21262d]/50">
                                                        <div className="flex gap-2">
                                                            <input
                                                                ...
                                                                onChange={(e) => setNewManualTaskTitles(prev => ({
                                                                    ...prev,
