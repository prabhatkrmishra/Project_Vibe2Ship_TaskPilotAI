...
export function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200 flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
      {/* Background visual art */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-500/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-cyan-500/5 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="max-w-md w-full text-center space-y-8 relative z-10">
        ...
        <div className="relative mx-auto w-32 h-32 flex items-center justify-center">
          ...
          <div className="w-16 h-16 bg-gradient-to-tr from-indigo-600 to-cyan-500 rounded-2xl flex items-center justify-center shadow-[0_0_50px_rgba(99,102,241,0.3)] transform rotate-45 hover:rotate-180 transition-transform duration-1000">
            <Compass className="h-8 w-8 text-white transform -rotate-45" />
          </div>
          <div className="absolute -top-1 -right-1 bg-red-500/10 border border-red-500/30 rounded-full p-1 text-red-400">
