                        ...
                        <DialogContent className="bg-[#0d1117] border border-[#21262d] text-[#f0f6fc]">
                            ...
                            <form onSubmit={handleCreateTask} className="space-y-4 mt-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                        <Input
                                            ...
                                            placeholder="e.g. Complete Spring Boot Backend" required/>
                                        <Button
                                            type="button"
                                            variant="outline"
                                ...
                                <div className="space-y-3 flex flex-col">
                                    ...
                                    <Popover>
                                        <PopoverTrigger
                                            className={`inline-flex items-center justify-start whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border h-10 px-4 py-2 w-full font-normal bg-slate-800/50 border-slate-700 hover:bg-slate-800 hover:text-white ${!date ? 'text-slate-500' : 'text-white'}`}>
                                ...
                                {date && (
                                    <div className="space-y-2">
                                        ...
                                        {isLoadingTimetable ? (
                                            <div
                                                className="text-xs text-indigo-400 animate-pulse font-mono py-1">Fetching
                                                daily timetable...</div>
...
{Array.from({length: 24 * 2}).map((_, i) => {
                                ...
                                {timeConflict && (
                                    <div
                                        className="p-3 bg-amber-500/10 border border-amber-500/20 text-amber-300 rounded-xl text-[11px] leading-relaxed font-medium animate-in fade-in duration-200">
                                        {timeConflict}
                                    </div>
                                )}
                                <Button type="submit"
                                        className="w-full bg-gradient-to-r from-indigo-600 to-violet-500 hover:from-indigo-500 hover:to-violet-400 text-white border-0 font-bold tracking-widest uppercase text-xs rounded-xl"
            ...
            {loading ? (
                ...
                <motion.div layout className="grid grid-cols-12 gap-4 items-start">
                  ...
                  <span
                      className={`px-2 py-0.5 text-[10px] font-bold rounded uppercase tracking-wider ${task.priority === 'high' ? 'bg-red-500/15 text-red-400 border border-red-500/25' : task.priority === 'medium' ? 'bg-orange-500/15 text-orange-400 border border-orange-500/25' : 'bg-emerald-500/15 text-emerald-400 border border-emerald-500/25'}`}>
                    {task.priority}
                  </span>
                                        <span
                    ...
                    <Clock className="w-3 h-3 mr-1"/>
                      ...
                      Risk: {task.riskScore}%
                                        ...
                                        {(() => {
                                            ...
                                            return matchingGoal ? (
                                                <span
                                                    className="px-2 py-0.5 text-[10px] font-bold rounded uppercase tracking-wider bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 flex items-center gap-1">
                    ...
                    <span className="flex items-center gap-1">
                      Subtasks <span className="text-indigo-400 font-mono">({done}/{total})</span>
                                            ...
                                            <span className="text-[9px] transition-transform duration-200"
                                                  style={{transform: expandedTasks[task.id] ? 'rotate(180deg)' : 'rotate(0deg)'}}>
                      ▼
                    </span>
                                        </button>
                                    ...
                                    {sub.title}
                                                    ...
                                                    <div className="mt-4 pt-4 border-t border-[#21262d]/50 space-y-4">
                                                        ...
                                                        <div className="space-y-1.5">
                                                            ...
                                                            >
                                                                <Sparkles
                                                                    className={`w-3.5 h-3.5 text-cyan-400 ${isGeneratingSubtasks[task.id] ? 'animate-spin' : ''}`}/>
                                                                <span>
                                                        ...
                                                        <div className="space-y-1.5 pb-2">
                                                            ...
                                                            <div className="flex flex-col sm:flex-row gap-2">
                                                                <input
                                                                    ...
                                                                    onChange={(e) => setNewSubtaskTexts(prev => ({
                                                                        ...prev,
