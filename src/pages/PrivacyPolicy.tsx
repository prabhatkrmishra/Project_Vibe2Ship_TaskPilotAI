        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <div
                        className="flex items-center gap-3 bg-indigo-500/10 border border-indigo-500/20 px-4 py-2 rounded-2xl w-fit">
                        <Shield className="h-5 w-5 text-indigo-400"/>
                        <span
                            className="text-xs font-semibold text-indigo-300 tracking-wider uppercase">Secure Platform</span>
                    </div>
                </div>
                ...
                <div className="space-y-8 text-slate-300 leading-relaxed relative z-10">
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            Welcome to <strong>TaskPilot AI</strong> ("we", "our", or "us"). We are committed to
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="bg-slate-900/50 border border-slate-800 p-4 rounded-2xl text-slate-300 text-sm">
                            <strong>Crucial Google API Scopes Disclosure:</strong> TaskPilot AI requests access to
                            specific Google Workspace API scopes to power its autonomous productivity and file
                            management tools. We adhere strictly to the <a
                            href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank"
                            rel="noopener noreferrer" className="text-indigo-400 hover:underline">Google API Services
                            User Data Policy</a>, including the Limited Use requirements.
                        </p>
                        <p>
                            We request and use the following Google scopes exclusively for the core features listed
                            below:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-sm text-slate-400">
                            <li>
                                <strong className="text-slate-200">Google Calendar (<code
                                    className="bg-slate-900 px-1 py-0.5 rounded text-indigo-300">.../auth/calendar</code>):</strong> Used
                                to fetch your schedule, identify conflicts, suggest optimal task slots, and write new
                                productivity events to your calendar.
                            </li>
                            <li>
                                <strong className="text-slate-200">Google Drive (<code
                                    className="bg-slate-900 px-1 py-0.5 rounded text-indigo-300">.../auth/drive</code>):</strong> Used
                                to search, organize, and reference relevant source documents that you select to assist
                                in drafting tasks and plans.
                            </li>
                            <li>
                                <strong className="text-slate-200">Google Docs (<code
                                    className="bg-slate-900 px-1 py-0.5 rounded text-indigo-300">.../auth/documents</code>):</strong> Used
                                to compile action plans, export summary documents, and read task briefs.
                            </li>
                            <li>
                                <strong className="text-slate-200">Google Sheets (<code
                                    className="bg-slate-900 px-1 py-0.5 rounded text-indigo-300">.../auth/spreadsheets</code>):</strong> Used
                                to fetch status trackers and synchronize structured task checklists.
                            </li>
                            <li>
                                <strong className="text-slate-200">Google Slides (<code
                                    className="bg-slate-900 px-1 py-0.5 rounded text-indigo-300">.../auth/presentations</code>):</strong> Used
                                to export mission summaries and project quests into slides.
                            </li>
                        </ul>
                        <p className="text-sm">
                            Our use of information received from Google APIs will adhere to the Google API Services User
                            Data Policy, including the Limited Use requirements. Your Google data
                            is <strong>never</strong> sold, shared with third-party advertisers, or used to train public
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="bg-[#161b22] border border-[#21262d] p-4 rounded-2xl flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400 mt-1">Your name, email address, and profile
                            ...
                            <div className="bg-[#161b22] border border-[#21262d] p-4 rounded-2xl flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400 mt-1">Tasks, descriptions, priority scores, and
                                        risk parameters created within TaskPilot AI.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="flex gap-4 bg-[#161b22] border border-[#21262d] p-5 rounded-2xl">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-slate-400">
                                    All communications between your browser and our servers are encrypted using Secure
                                    Socket Layer (SSL/TLS) technology. User credentials and OAuth tokens are stored
                                    securely in Firestore using isolated permissions rules and environment-level secrets
                                    to guarantee safety.
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            We do not share, sell, rent, or trade your personal information or Google API data with
                            third parties for their promotional purposes. Your data is stored for as long as your
                            account remains active. You can request complete deletion of your account and associated
                            tokens at any time by contacting us.
                        </p>
                    </section>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            If you have any questions or concerns about this Privacy Policy, please feel free to reach
                            out to our team at:
                        </p>
                        <div
