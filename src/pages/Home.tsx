...
export function Home() {
    ...
    return (
        <div
            ...
            <div
                className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] bg-[radial-gradient(ellipse_at_top,rgba(99,102,241,0.15),transparent_50%)] pointer-events-none"/>
            <div
                className="absolute top-[400px] right-[-10%] w-[500px] h-[500px] bg-indigo-500/5 rounded-full blur-[140px] pointer-events-none"/>
            <div
                className="absolute top-[800px] left-[-10%] w-[500px] h-[500px] bg-cyan-500/5 rounded-full blur-[140px] pointer-events-none"/>
              ...
              TaskPilot <span className="text-indigo-400 font-semibold italic">AI</span>
                    ...
                    <div className="flex items-center gap-4">
                        {user ? (
                            ...
                            <>
                                <Link to="/login"
                                      className="hidden sm:inline-flex text-slate-400 hover:text-white text-sm font-medium px-4 py-2 transition-colors">
                                    Sign In
                                </Link>
                                <Link
                                    to="/login"
            ...
            <section className="relative pt-20 pb-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    {/* Badge */}
                    <div
                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-xs text-indigo-300 font-medium tracking-wide mx-auto select-none">
                    ...
                    <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
                        TaskPilot AI acts as a smart autonomous planner, compiling project timelines, scheduling slots,
                        and managing your files using secure Google Workspace API integrations.
                    </p>
                ...
                <div
                    ...
                    <div
                        ...
                        <div className="flex items-center justify-between border-b border-[#21262d] pb-4">
                            ...
                            <div
                                className="h-6 w-48 bg-slate-800/50 rounded-lg flex items-center justify-center text-[10px] font-mono text-slate-500">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-[#161b22] border border-[#21262d] p-4 rounded-xl space-y-3">
                                        <div className="flex justify-between">
                                            ...
                                            <div
                                                className="h-4 w-12 bg-emerald-500/10 border border-emerald-500/30 rounded"/>
                                        </div>
                                        <div className="h-3 w-full bg-slate-800/50 rounded"/>
            ...
            <section id="workspace"
                ...
                <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        <div
                            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-xs text-cyan-300 font-medium">
                        ...
                        <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
                            TaskPilot AI operates in strict collaboration with your official workspace apps. Access
                            credentials are encrypted securely on our cloud servers and can be revoked instantly.
                        </p>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex gap-3 text-sm">
                                ...
                                <span
                                    className="text-slate-300">Direct integration with Drive files, Sheets, & Slides</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-8 bg-[#0d1117] border border-[#21262d] rounded-3xl space-y-6 shadow-xl relative">
                        ...
                        <div className="space-y-3 font-mono text-xs text-slate-400">
                            <div
                                ...
                                <span
                                    className="text-[10px] bg-indigo-500/10 text-indigo-300 border border-indigo-500/20 px-2 py-0.5 rounded">auth/calendar</span>
                            </div>
                            <div
                                className="bg-slate-900/80 p-3 rounded-xl border border-slate-800 flex justify-between items-center">
                                <span>Google Drive API</span>
                                <span
                                    className="text-[10px] bg-cyan-500/10 text-cyan-300 border border-cyan-500/20 px-2 py-0.5 rounded">auth/drive</span>
                            </div>
                            <div
                                className="bg-slate-900/80 p-3 rounded-xl border border-slate-800 flex justify-between items-center">
                                <span>Google Documents API</span>
                                <span
                                    className="text-[10px] bg-violet-500/10 text-violet-300 border border-violet-500/20 px-2 py-0.5 rounded">auth/documents</span>
                            </div>
                        </div>
                        <p className="text-[11px] text-slate-500 leading-snug">
                            TaskPilot AI complies strictly with the Google API Services User Data Policy, ensuring no
                            unauthorized telemetry or model training occurs using personal data.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section id="compliance" className="py-24 px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div
                        className="absolute top-0 right-0 w-48 h-48 bg-orange-500/5 rounded-full blur-2xl pointer-events-none"/>
                    <div
                    ...
                    <div
                        ...
                        <div
                            className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-2xl w-fit text-emerald-400">
                    ...
                    <div className="grid sm:grid-cols-2 gap-8 text-sm">
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                                TaskPilot AI respects your digital personal data rights as mandated under India’s
                                Digital Personal Data Protection Act, 2023. You have full controls to view, correct, or
                                request the deletion of your account metadata.
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                                All software processing, Google cloud storage triggers, and data encryption modules
                                comply with the Information Technology Act, 2000 and the allied IT Rules, ensuring
                                high-grade data protection.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <footer className="border-t border-slate-900 bg-[#0d1117] py-12 px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div className="flex gap-6">
                        ...
                        <span className="text-slate-400">Grievance contact: <strong
                            className="text-indigo-400 font-normal">taskpilot.ai.support@gmail.com</strong></span>
                    </div>
