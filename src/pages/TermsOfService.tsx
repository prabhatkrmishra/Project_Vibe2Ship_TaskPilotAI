        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <div
                        className="flex items-center gap-3 bg-cyan-500/10 border border-cyan-500/20 px-4 py-2 rounded-2xl w-fit">
                        <Scale className="h-5 w-5 text-cyan-400"/>
                        <span
                            className="text-xs font-semibold text-cyan-300 tracking-wider uppercase">Legal Framework</span>
                    </div>
                </div>
                ...
                <div className="space-y-8 text-slate-300 leading-relaxed relative z-10">
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            By accessing or using <strong>TaskPilot AI</strong> ("Service"), you agree to be bound by
                            these Terms of Service ("Terms") and all applicable Indian laws, rules, and regulations. If
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            TaskPilot AI is an autonomous, AI-driven task management and productivity application. The
                            Service integrates with Google Workspace APIs (Calendar, Drive, Docs, Sheets, Slides) to
                            automate, organize, and synthesize tasks, documents, and calendars for your personal or
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            Permission is granted to temporarily access the Service for personal or professional use.
                            Under this license and in accordance with Indian cyber laws, you may not:
                        </p>
                        <ul className="list-disc pl-6 space-y-1 text-sm text-slate-400">
                            <li>Modify, copy, or distribute the materials.</li>
                            <li>Attempt to decompile, reverse engineer, or hack any software contained in the Service.
                            </li>
                            <li>Remove any copyright or other proprietary notations from the materials.</li>
                            <li>Host, display, upload, modify, publish, transmit, store, update or share any information
                                that is harmful, harassing, defamatory, obscene, or violates any active Indian law.
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="bg-[#161b22] border border-[#21262d] p-5 rounded-2xl space-y-3">
                            <p className="text-sm text-slate-300">
                                ...
                                as specified during consent. We handle all data in compliance with the Information
                                Technology Act, 2000, IT Rules 2011, and the Digital Personal Data Protection (DPDP)
                                Act, 2023.
                            </p>
                            <div className="flex gap-3 items-start">
                                <CheckCircle2 className="h-5 w-5 text-emerald-400 flex-shrink-0 mt-0.5"/>
                                <p className="text-xs text-slate-400">
                                    You retain complete ownership over all files, calendar entries, and data generated
                                    or edited via Google Workspace APIs.
                                </p>
                            </div>
                            <div className="flex gap-3 items-start">
                                <CheckCircle2 className="h-5 w-5 text-emerald-400 flex-shrink-0 mt-0.5"/>
                                <p className="text-xs text-slate-400">
                                    You may revoke TaskPilot AI's access to your Google Account at any time through your
                        ...
                        <div className="flex gap-4 bg-amber-500/5 border border-amber-500/10 p-5 rounded-2xl">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-slate-400 leading-relaxed">
                                    The services and materials on TaskPilot AI are provided on an "as is" and "as
                                    available" basis. We make no warranties, expressed or implied, and hereby disclaim
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            In no event shall TaskPilot AI or its partners be liable for any damages (including, without
                            limitation, damages for loss of data or profit, or due to business interruption) arising out
                            of the use or inability to use the materials or integration services, even if we have been
                            notified of the possibility of such damage under relevant Indian statutes.
                        </p>
                    </section>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            These Terms of Service, your relationship with the Service, and any disputes arising out of
                            or in connection with them shall be governed by, and construed in accordance with, the laws
                            of India (specifically the Information Technology Act, 2000, and allied rules). Any legal
                            action or proceeding related to this Service shall be brought exclusively in the competent
