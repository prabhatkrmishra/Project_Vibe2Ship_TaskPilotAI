...
export default function PageHeader({ icon: Icon, badge, color, title, titleAccent, description, actions }: PageHeaderProps) {
  const c = COLOR_MAP[color];
  return (
    <header className="flex flex-col gap-3 border-b border-[#21262d] pb-6 mb-2">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex flex-col gap-1.5">
          <div className={`flex items-center gap-2 text-xs font-bold uppercase tracking-widest font-mono ${c.badgeText}`}>
