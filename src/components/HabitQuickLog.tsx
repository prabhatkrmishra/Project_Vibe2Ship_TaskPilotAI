    ...
    return (
      <div className="space-y-1.5">
        ...
        {items.map(h => (
          ...
          >
            <div className="shrink-0 w-7 h-7 rounded-lg bg-orange-500/10 border border-orange-500/20 flex items-center justify-center">
              {logging === h.id ? (
      ...
      >
        <div className="flex items-center justify-between px-3 py-2.5 border-b border-[#21262d]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-orange-400 bg-orange-500/15 px-1.5 py-0.5 rounded-md">
