...
const stageStyles: Record<ReminderStage, { bg: string; border: string; text: string; iconBg: string; icon: typeof Bell }> = {
  approaching: { bg: 'bg-slate-800/95', border: 'border-slate-600/50', text: 'text-slate-300', iconBg: 'bg-slate-700/60 text-slate-300', icon: Clock },
  soon:        { bg: 'bg-amber-950/95', border: 'border-amber-500/40', text: 'text-amber-300', iconBg: 'bg-amber-500/15 text-amber-400', icon: Bell },
  logging:     { bg: 'bg-indigo-950/95', border: 'border-indigo-500/50', text: 'text-indigo-300', iconBg: 'bg-indigo-500/15 text-indigo-400', icon: Flame },
  overdue:     { bg: 'bg-red-950/95', border: 'border-red-500/50', text: 'text-red-300', iconBg: 'bg-red-500/15 text-red-400', icon: AlertTriangle },
};
